...
public class MenuPlanta extends JPanel {
	...
	public MenuPlanta() {
		...
		btn_buscarPlanta.setBounds(10, 11, 190, 37);
		...
		JButton btn_flujoMaxEntrePlantas = new JButton("FLUJO MAXIMO ENTRE 2 PLANTAS");
		btn_flujoMaxEntrePlantas.setBounds(210, 11, 241, 37);
		...
		JButton btn_verCaminoEntrePlantas = new JButton("CAMINO MINIMO ENTRE LAS PLANTAS");
		...
		btn_verCaminoEntrePlantas.setBounds(461, 11, 241, 37);
		add(btn_verCaminoEntrePlantas);
		
		JButton btn_verRutasPosibles = new JButton("VER RUTAS POSIBLES ENTRE PLANTAS");
		...
		btn_verRutasPosibles.setBounds(712, 11, 253, 37);
